...
>
> **Se você quer sua própria versão**, a licença é MIT: faça o fork, adapte e
> publique. Não precisa pedir e não precisa avisar.
>
> Apague este bloco se ainda assim quiser registrar a proposta.
...
<!-- `npm run teste` precisa passar. Se você mexeu em faixa, peso ou fórmula e
     alguma verificação quebrou, leia o que quebrou antes de ajustar a asserção:
     a asserção costuma estar certa. -->
